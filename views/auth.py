...
def login():
    if request.method == 'POST':
        ...
        if user:
            if check_password_hash(user.password,password):#check the password from db
        ...
        #get Data from Html
            if request.method == 'POST':
                            ...
                            if  user  :
                                ...
                                flash('User Name must be less than 12 characters and greater than 1 characters.',category='error')
                                return render_template('sign_up.html')
